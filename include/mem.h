...
static Bit8u Mem_aLodsb(PhysPt addr)
	{
	return *(Bit8u *)(MemBase+addr);
	}

static Bit16u Mem_aLodsw(PhysPt addr)
	{
...
static Bit8u Mem_Lodsb(Bit16u seg, Bit16u off)
	{
	return Mem_Lodsb((seg<<4)+off);
	}

static Bit16u Mem_Lodsw(Bit16u seg, Bit16u off)
	{
	return Mem_Lodsw((seg<<4)+off);
	}

static Bit32u Mem_Lodsd(Bit16u seg, Bit16u off)
	{
	return Mem_Lodsd((seg<<4)+off);
	}

static void Mem_Stosb(Bit16u seg, Bit16u off, Bit8u val)
	{
	Mem_Stosb(((seg<<4)+off), val);
	}
